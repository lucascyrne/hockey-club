...
No **2P horizontal** (portrait e tablet landscape), a metade do P2 usa roll 180° na câmera (`withP2GoalCameraRoll`) — o mesmo roll no render e no raycast do toque, para esquerda/direita alinhadas à vista.
